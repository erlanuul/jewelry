...
export default function ExpenseSalary() {
    ...
    const salaryWithoutPaginationList = SalaryService.GetSalaryWithoutPagination({staff: form.values.manager})
                    ...
                    <div className='w-full flex flex-col justify-start items-start gap-[20px]'>
                        <div className="w-full grid grid-cols-2 gap-[30px] mb-[60px]">
                            ...
                            <CustomFormControl variant='outlined' required>
                                ...
                                >
                                    {salaryWithoutPaginationList.loading
                                        ? <div>loading</div>
                                        : salaryWithoutPaginationList.error
                                            ? <div>Error</div>
                                            : salaryWithoutPaginationList.result?.data.map((item: any) => (
                                ...
                                {form.validation.message.salary !== '' &&
                                    <FormHelperText>{form.validation.message.salary}</FormHelperText>
                                }
                            </CustomFormControl>
