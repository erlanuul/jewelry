        ...
        <>
            <div className='w-full p-[20px] bg-white rounded-[10px] shadow-md grid grid-cols-2 gap-[20px]'>
                {clientInfo.images.length > 0
                    ...
                    :
                    <div
                        className='flex flex-col justify-center items-center rounded-[5px] bg-[#F6F6F6] w-[131px] h-[131px]'>
                ...
                <div className='flex flex-col justify-center items-start gap-[22px]'>
                    ...
                    <p className='text-[#2A2826] text-[14px] font-[500]'>{clientInfo.full_name}</p>
                </div>
                <div className='flex flex-col justify-center items-start gap-[22px]'>
                    <p className='text-[#6E6C6A] text-[12px] font-[500]'>ИНН:</p>
                    <p className='text-[#2A2826] text-[14px] font-[500]'>{clientInfo.inn}</p>
                </div>
                <div className='flex flex-col justify-center items-start gap-[22px]'>
                    <p className='text-[#6E6C6A] text-[12px] font-[500]'>Номер телефона:</p>
                    <p className='text-[#2A2826] text-[14px] font-[500]'>{clientInfo.phone}</p>
                </div>
                <div className='flex flex-col justify-center items-start gap-[22px]'>
                    <p className='text-[#6E6C6A] text-[12px] font-[500]'>Платежеспособность:</p>
                    <p className='text-[#2A2826] text-[14px] font-[500]'>{clientInfo.solvency ? 'Да' : 'Нет'}</p>
                </div>
                <div className='flex flex-col justify-center items-start gap-[22px]'>
